...
{
    /// <summary>
    /// An instance of the download client. This instance can be re-used. But besides it can be re-used, make sure to set the sufficient <c>MaxConnection</c> of the <seealso cref="HttpClient"/>
    ...
    public sealed partial class DownloadClient
    {
        ...
        /// </summary>
        /// <param name="speedLimit">Set the limit of the speed. The default -1 (No limit).<br/>
        /// The minimum size is: 262144 bytes (256 KiB/s). If the value is below the minimum limit, the speed will be set to 256 KiB</param>
        public static void SetSharedDownloadSpeedLimit(int speedLimit = -1) => DownloadSpeedLimitBase = speedLimit;
        ...
        public static DownloadClient CreateInstance([NotNull] HttpClient httpClient, int retryCountMax = DefaultRetryCountMax,
            TimeSpan? retryAttemptInterval = null, TimeSpan? timeoutAfterInterval = null)
        {
        ...
        /// <summary>
        /// Start the download process of the file asynchronously. This method can be used for single-session or multi-session download.
        /// </summary>
        ...
        /// The start position of the data to be downloaded. If this argument is set with <paramref name="offsetEnd"/> to <c>null</c>,<br/>
        /// the download will start from the beginning of the data. The <paramref name="offsetStart"/> argument cannot be set more than or equal as <paramref name="offsetEnd"/>.<br/><br/>
        /// Default: <c>null</c>
        /// </param>
        /// <param name="offsetEnd">
        /// The end position of the data to be downloaded. If this argument is set to <c>null</c>,<br/>
        /// the download will write the data until the end of the data. The <paramref name="offsetEnd"/> argument cannot be set less than or equal as <paramref name="offsetStart"/>.<br/><br/>
        /// Default: <c>null</c>
        /// </param>
        ...
        /// then it will fallback to the default value: 4.<br/><br/>
        /// Default: <c>4</c>
        /// </param>
        ...
        /// Cancellation token. If not assigned, a cancellation token will not be assigned and the download becomes non-cancellable.
        /// </param>
        /// <exception cref="ArgumentNullException"><paramref name="url"/> or <paramref name="fileOutputPath"/> is null.</exception>
        /// <exception cref="ArgumentException"><paramref name="url"/> or <paramref name="fileOutputPath"/> is empty or only have whitespaces.</exception>
        public async Task DownloadAsync([NotNull] string url, [NotNull] string fileOutputPath, bool useOverwrite = false,
            ...
            CancellationToken cancelToken = default)
        {
            ...
            ActionBlock<ChunkSession> actionBlock = new ActionBlock<ChunkSession>(
                async (chunk) =>
                {
                    using (FileStream stream = new FileStream(chunk.CurrentMetadata?.OutputFilePath!, FileMode.OpenOrCreate, FileAccess.Write, FileShare.Write))
                    {
        ...
        /// <summary>
        /// Start the download process to a <seealso cref="Stream"/> asynchronously.
        /// </summary>
        ...
        /// However, this argument will be ignored if the <paramref name="outputStream"/> is not seekable and <paramref name="offsetStart"/> is set to > 0.
        /// </param>
        /// <param name="offsetStart">
        /// The start position of the data to be downloaded. If this argument is set with <paramref name="offsetEnd"/> to <c>null</c>,<br/>
        /// the download will start from the beginning of the data. The <paramref name="offsetStart"/> argument cannot be set more than or equal as <paramref name="offsetEnd"/>.<br/><br/>
        ...
        public async Task DownloadAsync([NotNull] string url, [NotNull] Stream outputStream,
            ...
            CancellationToken cancelToken = default)
        {
            ...
            // If the outputStream is seeked, then advance the downloaded progress.
            if (isSeeked)
